...
import { marked } from "/viewer/modules/marked/marked.esm.js";
import { default as highlight } from "/viewer/modules/highlight/es/highlight.min.js";

import bash from "/viewer/modules/highlight/es/languages/bash.min.js";
highlight.registerLanguage("language-bash", bash);
highlight.registerLanguage("language-sh", bash);
import css from "/viewer/modules/highlight/es/languages/css.min.js";
highlight.registerLanguage("language-css", css);
import javascript from "/viewer/modules/highlight/es/languages/javascript.min.js";
...
import json from "/viewer/modules/highlight/es/languages/json.min.js";
highlight.registerLanguage("language-json", json);
import markdown from "/viewer/modules/highlight/es/languages/markdown.min.js";
highlight.registerLanguage("language-markdown", markdown);
import powershell from "/viewer/modules/highlight/es/languages/powershell.min.js";
highlight.registerLanguage("language-powershell", powershell);
import sql from "/viewer/modules/highlight/es/languages/sql.min.js";
highlight.registerLanguage("language-sql", sql);
import xml from "/viewer/modules/highlight/es/languages/xml.min.js";
